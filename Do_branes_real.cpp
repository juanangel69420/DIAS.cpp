...
int main()
{
    ...
    matrix V1 = matrix::Zero(), V2 = V1, V3 = V1, V4 = V1, V5 = V1, V6 = V1, V7 = V1, V8 = V1, V9 = V1;
    ...
    for (int i = 0; i < N; i++)
    {
        for (int j = 0; j < N; j++)
        {
            X1(i, j) = gauss_dist(rng), X1(j, i) = X1(i, j);
            X2(i, j) = gauss_dist(rng), X2(j, i) = X2(i, j);
            X3(i, j) = gauss_dist(rng), X3(j, i) = X3(i, j);
            X4(i, j) = gauss_dist(rng), X4(j, i) = X4(i, j);
            X5(i, j) = gauss_dist(rng), X5(j, i) = X5(i, j);
            X6(i, j) = gauss_dist(rng), X6(j, i) = X6(i, j);
            X7(i, j) = gauss_dist(rng), X7(j, i) = X7(i, j);
            X8(i, j) = gauss_dist(rng), X8(j, i) = X8(i, j);
            X9(i, j) = gauss_dist(rng), X9(j, i) = X9(i, j);
            if (i == N-1 && i == j)
            {
