...
int main()
{
    ...
    for (int i = 0; i < iterations; i++)
    {
        if (i % 1000 == 0)
        {
            ...
            std::cout << K(U12,U13,U21,U23,U31,U32,U14,U24,U34,U41,U42,U43)+V_D(Z12,Z13,Z21,Z23,Z31,Z32,Z14,Z24,Z34,Z41,Z42,Z43,c1,c2,c3,c4) << std::endl;
            std::cout << "Z12 = " << Z12 << std::endl << "Z13 = " << Z13 << std::endl << "Z21 = "<< Z21 << std::endl;
        }
